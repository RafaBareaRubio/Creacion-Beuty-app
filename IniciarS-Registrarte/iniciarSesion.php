                                        ...
                                        try {
                                            ...
                                            if ($persona!="") {
                                                if($persona['confirmado']=='0'){
                                                    ...
                                                    echo '<div id="errores" class="col-auto errores"> -Tu usuario ha sido betado momentaneamente</div>';
                                                }
                                            }else if($usuario!="" && $contrasena!=""){
                                                echo '<div id="errores" class="col-auto errores"> -Usuario o Contraseña incorrectos</div>';
                                            }

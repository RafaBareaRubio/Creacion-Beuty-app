            ...
            <div class="container col-12 mb-5 mt-3 text-center ">
                <div class="row p-2 justify-content-center align-items-center">
                    <div class="card col-auto pt-2" style="width: 75%;">
                        <img src="../img/Salon/salon3.jpeg" class="card-img-top" alt="...">
                        <div class="card-body">
                            <h5 class="card-title ">La Creacion</h5>
                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            ...
                                            <form class="contactame">
                                                <input type="text" placeholder="Nombre">
                                                <br>
                                                <input type="email" placeholder="E-mail" class="mt-3">
                                                <br>
                                                <textarea type="text" placeholder="Texto" class="mt-3"></textarea>
                                                <br>
                                                <p>¿Te Gusta la app?</p>
                                                <button class="emoji" value="si" type="button" id="Bien" onclick="botonFormularioBien()">&#128512;</button><button class="emoji" value="no" id="Mal" type="button" onclick="botonFormularioMal()">&#128528;</button>
                                            </form>
        ...
        <section>
            ...
            <div class="container col-12 mt-2">
                <div class="row justify-content-center align-content-center">
                    <div class="col-auto ubi">
                        <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d6357.547476399265!2d-5.772832896527022!3d37.18184774124321!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0xd127f09e81bcc31%3A0xb9a8710dc82f6fa4!2sC.%20Antonio%20Machado%2C%2019%2C%2041710%20Utrera%2C%20Sevilla!5e0!3m2!1ses!2ses!4v1638184583021!5m2!1ses!2ses" width="100%" height="100%" style="border:0;" allowfullscreen="" loading="lazy"></iframe>
                        <p class="centrar mt-2">Calle: Antonio Machado 19, 41710, Utrera</p>
                    </div>
                </div>
            </div>
            <br><br>
...
<footer id="footer" class="footer-1 mt-5">
    ...
    <script src="../js/botonFormulario.js"></script>

    ...
    <article>
        ...
        <section>
            <form method="post" action="insertarProducto.php">
                <table>
                    <tr><td><p>Nombre</p><input name="nombre" id="nombre" type="text"></td></tr>

                    <tr><td><p>Unidad</p><input name="unidad" id="unidad" type="text"></td></tr>
                    
                    <tr><td><p>Precio</p><input name="precio" id="precio" type="text"></td></tr>

                    <tr><td><p>Oferta</p><textarea name="oferta" id="oferta" value="oferta"></textarea></td></tr>

                    <tr><td><p>Descripcion</p><textarea name="descripcion" id="descripcion" value="descripcion"></textarea></td></tr>

                    <tr><td><p>Foto</p><input type="file" name="foto" name="foto" id="foto" value="foto" accept="image/png, image/jpeg" class="input-100"></td></tr>

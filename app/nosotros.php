    ...
    <article>
        ...
        <section>
            <div class="lightbox mt-5">
                <div class="row">
                  <div class="col-lg-6">
                    <img src="../img/Salon/tarjetaCreacion.jpeg" data-mdb-img="https://mdbcdn.b-cdn.net/img/Photos/Slides/1.webp"
                      alt="Table Full of Spices" class="w-100 mb-3 mb-md-4 shadow-1-strong rounded" />
                    <img src="../img/Salon/lavavo.jpeg" data-mdb-img="https://mdbcdn.b-cdn.net/img/Photos/Square/1.webp"
                      alt="Coconut with Strawberries" class="w-100 shadow-1-strong mt-2 rounded" />
                  </div>
                  <div class="col-lg-6">
                    <img src="../img/Salon/salon4.jpeg" data-mdb-img="https://mdbcdn.b-cdn.net/img/Photos/Vertical/1.webp"
        ...
        <section>
            <div id="myCarousel" class="carousel slide" data-bs-ride="carousel">
                ...
                <button class="botonI carousel-control-prev" type="button" data-bs-target="#myCarousel" data-bs-slide="prev">
                  <span class="carousel-control-prev-icon" aria-hidden="true"></span>
                  <span class="visually-hidden">Previous</span>
                </button>
                <button class="botonD carousel-control-next" type="button" data-bs-target="#myCarousel" data-bs-slide="next">
...
<footer id="footer" class="footer-1 mt-5">
                ...
                <div class="col-xs-12 col-sm-6 col-md-3">
                    <div class="widget no-box">
                        ...
                        <ul class="thumbnail-widget">
                            <li>
                                <div class="thumb-content"><a href="../IniciarS-Registrarte/iniciarSesion.php">Iniciar Sesion</a></div>
                            </li>
                            <li>
    ...
    <!-- JQUERY -->
    <script src="http://ajax.googleapis.com/ajax/libs/jquery/3.6.0/jquery.min.js%22%3E"></script>

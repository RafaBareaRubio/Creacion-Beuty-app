...
<body>
    ...
    <article>
        ...
        <div class="container">
            ...
            <div class="slider carousel col-12 mt-4">
                <div class="row justify-content-center">
                    ...
                    error_log(0); 
                        ...
                        if(sizeof($servicioOferta)!=0){
                            echo "<h2 class='mt-5'>Ofertas Servicios</h2>";
                        }
                        
                        for ($i=0;$i<sizeof($servicioOferta);$i++){
                            echo "<div class='producto item'>";
                                echo "<a href='https://booksy.com/es-es/20227_la-creacion-beauty-concept_barberia_29784_bencarron#ba_s=sr_1' style='color: black;'>";
                                    ...
                                    echo "<div class='datos'>";
                                        ...
                                        echo "<h4 id='nombreServicio'>".$servicioOferta[$i]['nombre']."</h4>";
                                        echo "<small id='caracteristicas'>".$servicioOferta[$i]['descripcion']."</small>";
                                    echo "</div>";
                                    echo "<div class='precios'>";
                                        echo "<div>";
                                            echo "<h5>Precio</h5>";
                                            echo "<small id='precioServicio'>".$servicioOferta[$i]['precio']."€</small>";
                                        echo "</div>";
                                    echo "</div>";
                                    echo "<div class='precios'>";
                                        echo "<div>";
                                            echo "<h5>Oferta</h5>";
                                            echo "<small id='precioServicio'>".$servicioOferta[$i]['oferta']."</small>";
                                        echo "</div>";
                                    echo "</div>";
                                echo "</a>";
                            echo "</div>";
                        ...
                        for ($i=0;$i<sizeof($productoOferta);$i++){
                            echo "<div class='producto item'>";
                                echo "<a href='https://booksy.com/es-es/20227_la-creacion-beauty-concept_barberia_29784_bencarron#ba_s=sr_1' style='color: black;'>";
                                    echo "<div class='contenedor-imagen'>";
                                        echo "<img src='../img/Servicios/Barba2.jpeg' class='img-nohover'>";
                                    ...
                                    echo "<div class='datos'>";
                                        echo "<div class='starrr'></div>";
                                        echo "<h4 id='nombreServicio'>".$productoOferta[$i]['nombre']."</h4>";
                                        echo "<small id='caracteristicas'>".$productoOferta[$i]['descripcion']."</small>";
                                    echo "</div>";
                                    echo "<div class='precios'>";
                                        echo "<div>";
                                            echo "<h5>Precio</h5>";
                                            echo "<small id='precioServicio'>".$productoOferta[$i]['precio']."</small>";
                                        echo "</div>";
                                    echo "</div>";
                                    echo "<div class='precios'>";
                                        echo "<div>";
                                            echo "<h5>Oferta</h5>";
                                            echo "<small id='precioServicio'>".$productoOferta[$i]['oferta']."</small>";
                                        echo "</div>";
                                    echo "</div>";
                                echo "</a>";
                            echo "</div>";

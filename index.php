...
<body>
                                    ...
                                    if(isset($_SESSION['sesion_iniciada']) == true ){
                                        ...
                                        if($tipo=="usuario"){
                                            ...
                                            echo "<li class='nav-item mx-2 col-xl-3 col-lg-3 text-center mt-4'>
                                                    <a class='btn text-uppercase' id='botonUsuario' href='app/misDatos.php' tabindex='-1'><i class='far fa-user-circle'></i>"." ".$cliente["usuario"]."</></a>
                                                    <a class='btn text-uppercase' id='botonUsuario' href='php/logout.php' tabindex='-1'><i class='fas fa-user-alt-slash'></i></i> Cerrar Sesion</></a>
                                                    <a class='btn' id='usuarios' href='app/gestion/gestionUsuarios.php' ><i class='fas fa-user-cog'></i></a>
                                                </li>";
    ...
    <section>
            ...
            <div id="myCarousel" class="carousel slide mt-5" data-bs-ride="carousel">
                ...
                <div class="slide1 carousel-inner">
                    <div class="carousel-item active">
                        <img src="img/Salon/peluqueria.jpeg" width="100%" height="100%">

                    </div>
                    <div class="slide2 carousel-item">
                        <img src="img/Salon/salon1.jpeg" width="100%" height="100%">

                    </div>
                    <div class="slide3 carousel-item">
                        <img src="img/Salon/salon2.jpeg" width="100%" height="100%">
                    </div>
                </div>
                <button class="botonI carousel-control-prev" type="button" data-bs-target="#myCarousel"
                    data-bs-slide="prev">
                    <span class="carousel-control-prev-icon" aria-hidden="true"></span>
                    <span class="visually-hidden">Previous</span>
                </button>
                <button class="botonD carousel-control-next" type="button" data-bs-target="#myCarousel"
                    data-bs-slide="next">
        ...
        <section>
            <p class="centrar mt-3"><a href="app/contactanos.php">Contáctanos</a></p>
        </section>
